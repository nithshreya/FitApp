...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=103947&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&subId=[SUBID_ENCODED]&vp_content=plembed1817uqygkhin&vp_template=8457&cbuster=1597502741',
					origQString: 's=103947&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&subId=[SUBID_ENCODED]&vp_content=plembed1817uqygkhin&vp_template=8457',
					placementId: 103947,
					x: 400,
					y: 600,
					videoType: 'normal',
