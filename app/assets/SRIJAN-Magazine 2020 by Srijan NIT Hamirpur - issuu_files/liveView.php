...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=99667&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed1817jktpwiml&vp_template=7018&subId=[SUBID_ENCODED]&cbuster=1597502741',
					origQString: 's=99667&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed1817jktpwiml&vp_template=7018&subId=[SUBID_ENCODED]',
					placementId: 99667,
					x: 300,
					y: 250,
					videoType: 'normal',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Linux","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"83.0.4103.116","browserVersionMajor":"83","browserVersionMinor":"0"},"browser":"chrome","os":"linux","osVer":"","deviceType":"desktop"},
					isFpCookie: 0,
					geo: 'IN',
					dmaCode: 0,
					dynamicSetup: [],
